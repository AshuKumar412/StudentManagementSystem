...
import { AcademicCapIcon, ShieldCheckIcon, UserGroupIcon, TeacherIcon, EyeIcon, EyeSlashIcon, ArrowRightOnRectangleIcon, ArrowUpRightIcon } from '../components/common/Icons';
        ...
        <div className="w-full max-w-md space-y-6 my-auto">
          ...
          <div className="flex rounded-xl bg-[var(--surface-muted)] p-1 border border-[var(--border)] gap-1 shadow-2xs">
            <button
              ...
              className={
                'flex-1 py-2 px-2.5 text-xs font-bold rounded-lg transition-all flex items-center justify-center gap-1.5 cursor-pointer ' +
                (selectedRole === 'ADMIN'
            ...
            >
              <TeacherIcon className="w-4 h-4 text-purple-500" />
              <span>Faculty</span>
            </button>
            <button
              type="button"
          ...
          <div className="pt-4 border-t border-[var(--border)] text-center space-y-2.5">
            ...
            <div className="grid grid-cols-3 gap-2">
              <Link
                to="/register/student"
                className="py-2 px-2 text-xs font-semibold rounded-lg bg-indigo-50 dark:bg-indigo-950/40 text-indigo-700 dark:text-indigo-300 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 border border-indigo-200/60 dark:border-indigo-800/40 transition-colors text-center truncate shadow-2xs flex items-center justify-center gap-1.5"
              ...
              <Link
                to="/register/faculty"
                className="py-2 px-2 text-xs font-semibold rounded-lg bg-purple-50 dark:bg-purple-950/40 text-purple-700 dark:text-purple-300 hover:bg-purple-100 dark:hover:bg-purple-900/50 border border-purple-200/60 dark:border-purple-800/40 transition-colors text-center truncate shadow-2xs flex items-center justify-center gap-1.5"
              ...
              <Link
                to="/register/admin"
                className="py-2 px-2 text-xs font-semibold rounded-lg bg-amber-50 dark:bg-amber-950/40 text-amber-700 dark:text-amber-300 hover:bg-amber-100 dark:hover:bg-amber-900/50 border border-amber-200/60 dark:border-amber-800/40 transition-colors text-center truncate shadow-2xs flex items-center justify-center gap-1.5"
          ...
          <div className="card p-3.5 bg-[var(--surface-muted)] text-xs border border-[var(--border)]">
            <div className="flex items-center justify-between mb-2">
              <span className="font-semibold text-[var(--text-primary)] flex items-center gap-1.5">
                <ArrowUpRightIcon className="w-3.5 h-3.5 text-indigo-500" />
                Quick Demo Sign-In
              </span>
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                ...
                className="py-1.5 px-2 bg-[var(--surface)] border border-[var(--border)] rounded-lg hover:border-indigo-500 text-[var(--text-secondary)] hover:text-[var(--text-primary)] font-semibold text-[11px] transition-all cursor-pointer shadow-2xs flex items-center justify-center gap-1 text-center"
              >
              ...
              <button
                ...
                className="py-1.5 px-2 bg-[var(--surface)] border border-[var(--border)] rounded-lg hover:border-indigo-500 text-[var(--text-secondary)] hover:text-[var(--text-primary)] font-semibold text-[11px] transition-all cursor-pointer shadow-2xs flex items-center justify-center gap-1 text-center"
              >
                <TeacherIcon className="w-3 h-3 text-purple-500" />
                <span>Teacher</span>
              </button>
              <button
                type="button"
                ...
                className="py-1.5 px-2 bg-[var(--surface)] border border-[var(--border)] rounded-lg hover:border-indigo-500 text-[var(--text-secondary)] hover:text-[var(--text-primary)] font-semibold text-[11px] transition-all cursor-pointer shadow-2xs flex items-center justify-center gap-1 text-center"
              >
                <UserGroupIcon className="w-3 h-3 text-emerald-500" />
                <span>Student</span>
              </button>
            </div>
          </div>
